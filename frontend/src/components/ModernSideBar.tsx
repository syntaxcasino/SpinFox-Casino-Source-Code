...
export default function ModernSideBar() {
  ...
  const menuItems = [
    { name: tMenu("home"), icon: Home, href: "/", key: "home", gradient: "from-blue-400 to-cyan-400" },
    { name: tMenu("slots"), icon: Gamepad2, href: "/slots", key: "slots", gradient: "from-purple-400 to-pink-400" },
    { name: tMenu("sports"), icon: Trophy, href: "/sports", key: "sports", gradient: "from-orange-400 to-red-400" },
    { name: tMenu("promotions"), icon: Gift, href: "/promotions", key: "promotions", gradient: "from-green-400 to-emerald-400" },
    { name: tMenu("leaderboard"), icon: Crown, href: "/leaderboard", key: "leaderboard", gradient: "from-yellow-400 to-orange-400" },
    { name: tMenu("tournaments"), icon: Award, href: "/tournaments", key: "tournaments", gradient: "from-indigo-400 to-purple-400" },
    { name: tMenu("wallet"), icon: Wallet, href: "/wallet", key: "wallet", gradient: "from-teal-400 to-cyan-400" },
    { name: tMenu("settings"), icon: Settings, href: "/settings", key: "settings", gradient: "from-gray-400 to-slate-400" },
  ];
                ...
                return (
                  ...
                  >
                    <Link
                      ...
                      onClick={(e) => {
                        // Ensure the link click is not prevented by any parent handlers
                        e.stopPropagation();
                      }}
                    >
                      <div className={`relative flex items-center gap-4 p-3 rounded-xl transition-all duration-300 ${isActive
                        ...
                        {isActive && (
                          <motion.div
                            layoutId="activeBar"
                            className="absolute left-0 !top-1 w-1 h-8 bg-gradient-to-b from-primary to-purple-600 rounded-r-full shadow-lg [transform:none]"
                        ...
                        <AnimatePresence>
                          {isExpanded && (
                            <motion.span
                              ...
                              className={`text-sm font-semibold whitespace-nowrap overflow-hidden ${isActive
              ...
              {menuItems.slice(0, 5).map((item, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <div className={`relative p-3 rounded-2xl transition-all ${isActive
                  ...
                  {menuItems.map((item) => {
                    ...
                    return (
                      <Link
                        ...
                        className={`flex flex-col items-center gap-2 p-4 rounded-2xl transition-all ${isActive
                            ? "bg-gray-200 dark:bg-white/10 shadow-md"
                            : "bg-gray-100 dark:bg-black/10 hover:bg-gray-200 dark:hover:bg-white/5"
                          }`}
                      >
                        <Icon className={`w-6 h-6 ${isActive ? "text-primary" : "text-gray-600 dark:text-white/70"}`} />
